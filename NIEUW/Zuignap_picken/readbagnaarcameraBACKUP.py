...
def calibration():
    global PXTMTM
    features_mm_to_pixels_dict = {(593, 201): (172, 25), (862, 201): (366, 25), (859, -67): (365, 218), (592, -65): (172, 217)}
...
def printcoordinaten(PXTMTM):
    ...
    if World_Cord[0] <= 680:
        if righty >= lefty:                                                                                 # /
            xcord = round((World_Cord[0]) + math.cos(rotation_angle_rad + 0.000001) * 300)
            ycord = round((World_Cord[1]) - math.sin(rotation_angle_rad + 0.000001) * 300)
            Cord = [xcord, ycord, -86 - rotation_angle_deg + 180]
        else:                                                                                               # \
            xcord = round((World_Cord[0]) + math.cos(rotation_angle_rad + 0.000001) * 300)
            ycord = round((World_Cord[1]) + math.sin(rotation_angle_rad + 0.000001) * 300)
            Cord = [xcord, ycord, -86 + rotation_angle_deg + 180]
        ...
        if righty >= lefty:                                                                                 # /
            xcord = round((World_Cord[0]) - math.cos(rotation_angle_rad + 0.000001) * 300)
            ycord = round((World_Cord[1]) + math.sin(rotation_angle_rad + 0.000001) * 300)
            Cord = [xcord, ycord, -86 - rotation_angle_deg]
        else:                                                                                               # \
            xcord = round((World_Cord[0]) - math.cos(rotation_angle_rad + 0.000001) * 300)
            ycord = round((World_Cord[1]) - math.sin(rotation_angle_rad + 0.000001) * 300)
            Cord = [xcord, ycord, -86 + rotation_angle_deg]
